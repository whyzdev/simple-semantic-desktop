...
public class Polarizer {
    ...
    static final String POLARITY_DATA_DIRECTORY="/local/s/polaritydata";
	...
	loadModel("/local/s/polaritydata/polarity.model");
	//        train();
	//	saveTrainingModel();
        //evaluate();
    }
	...
	FileOutputStream fileOut = new FileOutputStream("/local/s/polaritydata/polarity.model");
