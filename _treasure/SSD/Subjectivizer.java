...
public class Subjectivizer {
    ...
    static final String SUBJECTIVITY_DATA_DIR="/local/s/subjectivitydata";
	...
	loadModel("/local/s/subjectivitydata/subjectivity.model");
	//        train();
	//        evaluate();
    }
    ...
    void train() throws IOException {
        ...
        FileOutputStream fileOut = new FileOutputStream("/local/s/subjectivity.model");
