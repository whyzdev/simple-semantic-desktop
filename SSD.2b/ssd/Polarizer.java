...
public class Polarizer {
    ...
    static final String POLARITY_DATA_DIRECTORY="../data/polaritydata";
	...
	loadModel("../data/polaritydata/polarity.model");
	//        train();
	//	saveTrainingModel();
        //evaluate();
    }
	...
	FileOutputStream fileOut = new FileOutputStream("../data/polaritydata/polarity.model");
