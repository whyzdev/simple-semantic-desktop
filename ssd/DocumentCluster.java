...
public class DocumentCluster{
    ...
    public void printClusterInfoHTML(File docDir) throws Exception{
	File outDir = new File(docDir, name + ".html");
	System.out.println("----------------------\nEntities of "+ name);
	for(int i=0;i<entities.size();i++){
	    if (entities.get(i)!=null)
		System.out.println("" + i + ": " + entities.get(i));
    ...
    public boolean checkLocation(String location){
    	//warning: airportlist is not being loaded anymore. Do not use this function until it is
